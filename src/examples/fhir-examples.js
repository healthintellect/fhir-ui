...
export const patientTest = {
  resourceType: 'Patient',
  id: 'f0462936-eb4b-4da1-b45a-fbd96ebf8ccb',
  meta: {
    versionId: '4',
    lastUpdated: '2019-05-08T04:30:52.182-04:00',
    profile: [
  ...
  text: {
    status: 'generated',
    div:
      '<div xmlns="http://www.w3.org/1999/xhtml">Generated by <a href="https://github.com/synthetichealth/synthea">Synthea</a>. Version identifier: 1a8d765a5375bf72f3b7a92001940d05a6f21189</div>',
  },
  extension: [
    {
    ...
    {
      url:
        'http://standardhealthrecord.org/fhir/StructureDefinition/shr-actor-FictionalPerson-extension',
      valueBoolean: true,
    },
    {
      url:
    ...
    },
    {
      ...
      valueString: '999-30-3436',
    },
  ],
  identifier: [
    {
      system: 'https://github.com/synthetichealth/synthea',
      value: '82cec34b-9acf-4661-876b-6439c435272e',
    },
    {
      type: {
        coding: [
  ...
  telecom: [
    {
      system: 'phone',
      value: '(464) 598-0875 x8332',
      use: 'home',
    },
  ],
  gender: 'male',
  birthDate: '1963-12-25',
  address: [
    {
      extension: [
        {
          ...
          extension: [
            {
              url: 'latitude',
              valueDecimal: 42.70251780965411,
            },
            {
              url: 'longitude',
              valueDecimal: -73.08575366724578,
            },
          ],
        },
      ],
      line: ['68436 Lucas Springs'],
      city: 'North Adams',
      state: 'MA',
      postalCode: '01247',
      country: 'US',
