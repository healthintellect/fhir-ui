...
const ObservationTable = ({
  ...
  const renderSubjectHeader = () => {
    if (!hideSubjects) {
      return <TableCell id="name">Subject</TableCell>
    }
  }
  ...
  const renderValueHeader = () => {
    if (!hideValue) {
      return <TableCell id="value">Value</TableCell>
    }
  }
  ...
  const renderCode = (code, value) => {
    if (!hideCode) {
      ...
      return <TableCell id="category">{code}</TableCell>
    }
  }
  ...
  const renderToggleHeader = () => {
    if (!hideCheckboxes) {
      return <TableCell id="toggle">Toggle</TableCell>
    }
  }
  ...
  const renderToggle = () => {
    if (!hideCheckboxes) {
      return (
        <TableCell id="toggle">
          <Checkbox defaultChecked={true} className={classes.root} />
        </TableCell>
      )
    }
  }
